...
import { LayoutDashboard, CheckSquare, Clock, Users, BarChart2 } from 'lucide-react';
...
export default function BottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 inset-x-0 z-40 bg-[#080c1a]/95 backdrop-blur-md border-t border-white/[0.06]">
